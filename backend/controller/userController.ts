...
export const emptyCart = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const req2 = req as IUserRequest
    const { id } = req2.user;
    validateMongodbId(id);
    try {
...
export const applyCoupon = asyncHandler(async (req: Request, res: Response): Promise<void> => {
