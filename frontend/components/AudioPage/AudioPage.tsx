...
const AudioPage: React.FC<IProps> = ({ data }) => {
                            ...
                            <div className={`${styles.filter_card} mb-3`}>
                                ...
                                <div>
                                    <ul className={styles.sidebar_brands}>
                                        <li>
                                            <div className='me-1'>
                                                <BsSpeaker className='fs-5'/>
                                            </div>
                                            <div>
                                                <Link className='fs-6' href={"/headphone"}>Tai nghe</Link>
                                            </div>
                                        </li>
                                        <li>
                                            <div className='me-1'>
                                                <BsHeadphones className='fs-5'/>
                                            </div>
                                            <div>
                                                <Link className='fs-6' href={"/speaker"}>Loa</Link>
                                            </div>
