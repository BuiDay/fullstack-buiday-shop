                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className={styles.main_product_details}>
                                ...
                                <div className={`${styles.border_bottom} py-3`}>
                                    <div className='detail_technical' dangerouslySetInnerHTML={{ __html: `${data?.technicalInfo}`}} />
                                </div>
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div  className="bg-white p-4 " style={{borderRadius:"10px"}}>
                                ...
                                {
                                    isShowDes ? (
                                        <div className='text-center mt-3' onClick={()=>setIsShowDes(false)}>
                                            Ẩn mô tả
                                        </div>
                                    ):(
                                        <div className='text-center mt-3' onClick={()=>setIsShowDes(true)}>
                                            Xem thêm
                                        </div>
                                    )
                                }
